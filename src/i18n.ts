...
const en: Translations = {
	...
	settings_sourceEudic: 'Eudic Dictionary (欧路词典)',
	settings_sourceYoudao: 'Youdao Dictionary (有道词典)',
	...
	notice_syncProgress: 'Syncing... {current}/{total}',
	notice_batchProgress: 'Batch updating... {current}/{total}: {word}',
	notice_skippingEdited: 'Skipped "{word}" (already has detailed content)',
	notice_batchSource: 'Using {source} for batch update',
	
	confirm_title: 'Confirm Sync',
	confirm_deleteWarning: 'Warning: This sync will delete items!',
	confirm_cloudDeletions: 'Words to delete from Eudic cloud: {count}',
	confirm_localDeletions: 'Local notes to mark as cloud-deleted: {count}',
	confirm_totalDeletions: 'Total items to be affected: {count}',
	confirm_proceed: 'Proceed with sync?',
...
const zh: Translations = {
	...
	notice_syncProgress: '正在同步... {current}/{total}',
	notice_batchProgress: '批量更新中... {current}/{total}: {word}',
	notice_skippingEdited: '跳过 "{word}"（已有详细内容）',
	notice_batchSource: '使用 {source} 进行批量更新',
	
	confirm_title: '确认同步',
	confirm_deleteWarning: '警告：此次同步将删除项目！',
	confirm_cloudDeletions: '将从欧路云端删除的单词：{count} 个',
	confirm_localDeletions: '将被标记为云端删除的本地笔记：{count} 个',
	confirm_totalDeletions: '总共将影响的项目：{count} 个',
	confirm_proceed: '是否继续同步？',
	confirm_cancel: '取消',
	confirm_continue: '继续',
